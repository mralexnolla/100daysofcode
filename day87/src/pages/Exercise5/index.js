...
//import moment from 'moment';   //no need for this import 
...
export const Exercise5 = () => {
  ...
  //   const reservationDateAndTime = moment('2022-04-26T23:30:00.000Z').format('MM/D/YYYY h:mmA');
  ...
  async function onClick() {
    ...
    const reservationDateAndTime = moment.default('2022-04-26T23:30:00.000Z').format('MM/D/YYYY h:mmA');
    setValue(reservationDateAndTime);
    setDetailsVisible(!detailsVisible);
  }
